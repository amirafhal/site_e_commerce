            ...
            <div class="col-md-6 mt-5 m-auto bg-white shadow font-monospace border border-info">
                ...
                <form action="insert.php" method="post">
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" required placeholder="Enter User Name" class="form-control">
                    </div>

                    <div class="mb-3">
                        <label for="">UserEmail</label>
                        <input type="email" name="email" required placeholder="Enter User Email" class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="password" name="password" required placeholder="Enter User Password" class="form-control">
                    </div>
